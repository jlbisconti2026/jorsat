...
1. [📦 Paso 1: Instalar dependencias necesarias](#-paso-1-instalar-dependencias-necesarias)
2. [📥 Paso 2: Descargar y compilar libhtp 0.5.47](#-paso-2-descargar-y-compilar-libhtp-0547)
3. [📥 Paso 3: Descargar y compilar suricata 7.x](#-paso-3-descargar-y-compilar-suricata-7x)
4. [Paso 4: Configurar Suricata con todas las opciones](#️-paso-4-configurar-suricata-con-todas-las-opciones)
5. [🛠️ Paso 5: Compilar e instalar](#️-paso-5-compilar-e-instalar)
6. [🔍 Paso 6: Verificar instalación](#-paso-6-verificar-instalación)
